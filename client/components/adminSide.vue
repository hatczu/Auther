...
export default {
  ...
  data() {
    return {
      ...
      collapsed: false,
      sidebarItems: [
        { key: 'home', icon: HomeOutlined, title: 'Home', route: '/admin/dashboard' },
        { key: 'users', icon: UserOutlined, title: 'Users', route: '/admin/users' },
        { key: 'settings', icon: SettingOutlined, title: 'Settings', route: '/admin/settings' }
      ],
      activeButton: null
    }
  },
